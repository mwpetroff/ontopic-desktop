...
const BA_DEMO_CHUNKS = [
  ...
  "Hi Rachel. I'm Pat Singh from procurement operations. The biggest pain for our team right now is that we manually re-enter invoices, purchase requisitions, and signed contracts from our top suppliers — Acme Manufacturing, Beacon Logistics, and Meridian Office Supplies — into two separate systems every single day. It takes about fifteen hours per person per week and we're getting data entry errors that delay supplier payments by up to ten days. It's costing us vendor goodwill.",
  ...
  "Pat again. I also need to stress the supplier onboarding problem. Onboarding a new supplier today takes an average of three weeks because we collect W-9 tax forms, banking details, and insurance certificates entirely by email and spreadsheets. We just lost a promising new supplier, Cascade Industrial Supply, because our onboarding process took too long and they went with a competitor instead. The new system should support a self-service supplier portal that cuts onboarding to under five business days.",
